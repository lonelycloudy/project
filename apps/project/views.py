...
def build_body_nav_menu(pt):
    bodymenus = [{'uri':'/all/', 'text':gettext('All')},
                 {'uri':'/hot/', 'text':gettext('Most hot')},
                 {'uri':'/newest/', 'text':gettext('Newest')},
                 {'uri':'/random/', 'text':gettext('Random')},
                 {'uri':'/watched/', 'text':gettext('Popular Watched')}]
