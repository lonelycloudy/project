...
u = ['',
     ...
     # static file
     #
     ('^css/(?P<path>.*)$', 'django.views.static.serve', {'document_root' : 'media/css'}),
     ('^js/(?P<path>.*)$',  'django.views.static.serve', {'document_root' : 'media/js'}),
     ('^img/(?P<path>.*)$', 'django.views.static.serve', {'document_root' : 'media/img'}),

     
     # user profilerr
     #
     ('^u/(?P<name>[\. \w]+)/$',  'apps.user.views.view_user'),
